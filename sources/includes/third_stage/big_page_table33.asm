...
edit_first:
	add r8, 0x10 ;add 8 bytes to make the pointer points to the start of the next entry 
    cmp r8, r10
	jl check_type_loop
    jmp make_flag_0 
within_range:
...
mov rcx, 0x101000 ;lsdt physical of page table levels
mov rdi, rcx
;mov cr3, rdi
